...
SPAWNDISTANCE	EQU	2		; distancia mínima entre barcos
...
end_game:								;ecrã perder jogo
		...
		STRING 080H, 000H, 000H, 001H
		STRING 080H, 000H, 000H, 001H
		STRING 08EH, 01CH, 022H, 079H
		STRING 090H, 022H, 036H, 041H
		STRING 093H, 03EH, 02AH, 071H
		STRING 091H, 022H, 022H, 041H
		STRING 08EH, 022H, 022H, 079H
		STRING 080H, 000H, 000H, 001H
		STRING 080H, 000H, 000H, 001H
		STRING 080H, 000H, 000H, 001H
		STRING 08EH, 022H, 03CH, 0F1H
		STRING 091H, 022H, 020H, 089H
		STRING 091H, 022H, 038H, 0F1H
		STRING 091H, 014H, 020H, 089H
		STRING 08EH, 008H, 03CH, 089H
		STRING 080H, 000H, 000H, 001H
		STRING 080H, 000H, 000H, 001H
		STRING 08EH, 0EEH, 0EEH, 071H
		STRING 08AH, 0A8H, 088H, 049H
		STRING 08EH, 0CCH, 0EEH, 051H
		STRING 088H, 0A8H, 022H, 049H
		STRING 088H, 0AEH, 0EEH, 049H
		STRING 080H, 000H, 000H, 071H
		STRING 080H, 000H, 000H, 001H
		STRING 080H, 000H, 000H, 001H
		STRING 080H, 000H, 000H, 001H
		STRING 080H, 000H, 000H, 001H
...
press_b_to_start:					;ecrã que aparece no inicio do jogo
		STRING 000H, 000H, 000H, 000H
		STRING 001H, 0DDH, 0DDH, 0C0H
		STRING 001H, 055H, 011H, 000H
		STRING 001H, 0D9H, 09DH, 0C0H
		STRING 001H, 015H, 004H, 040H
		STRING 001H, 015H, 0DDH, 0C0H
		STRING 000H, 000H, 000H, 000H
		STRING 000H, 000H, 000H, 000H
		STRING 000H, 000H, 000H, 000H
		STRING 000H, 000H, 000H, 000H
		STRING 000H, 00FH, 0C0H, 000H
		STRING 000H, 00CH, 060H, 000H
		STRING 000H, 00CH, 060H, 000H
		STRING 000H, 00CH, 060H, 000H
		STRING 000H, 00CH, 060H, 000H
		STRING 000H, 00DH, 0C0H, 000H
		STRING 000H, 00CH, 060H, 000H
		STRING 000H, 00CH, 060H, 000H
		STRING 000H, 00CH, 060H, 000H
		STRING 000H, 00CH, 060H, 000H
		...
		STRING 000H, 000H, 000H, 000H
		STRING 000H, 000H, 000H, 000H
		STRING 072H, 01DH, 0DDH, 0DCH
		STRING 025H, 010H, 095H, 048H
		STRING 025H, 01CH, 09DH, 088H
		STRING 025H, 004H, 095H, 048H
		STRING 022H, 01CH, 095H, 048H
		STRING 000H, 000H, 000H, 000H
		STRING 000H, 000H, 000H, 000H
